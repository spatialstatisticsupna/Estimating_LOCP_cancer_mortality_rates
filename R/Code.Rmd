...
```{r}
formula = Cases~ -1+i_P + i_LOCP + f(i, model="besag2", graph=g,hyper=pcprec, replicate=Gender)   +
  f(LOCP_het, model="iid",hyper=pcprec,constr =T) +
  f(Age_group, model="iid",hyper=pcprec,constr =T,replicate=Gender)
